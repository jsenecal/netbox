...
class CableImportForm(NetBoxModelImportForm):
    ...
    class Meta:
        model = Cable
        fields = [
            'side_a_site', 'side_a_device', 'side_a_circuit', 'side_a_type', 'side_a_name', 
            'side_b_site', 'side_b_device', 'side_b_circuit', 'side_b_type', 'side_b_name', 
            'type', 'status', 'tenant', 'label', 'color', 'length', 'length_unit', 'description',
            'comments', 'tags',
        ]
